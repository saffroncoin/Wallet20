...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    sendBitCoinsAction = new QAction(QIcon(":/icons/sfrbit"), tr("&SFRBit"), this);
    sendBitCoinsAction->setStatusTip(tr("Send Bitcoins using your Saffroncoins"));
    sendBitCoinsAction->setToolTip(sendBitCoinsAction->statusTip());
    ...
    explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Block Explorer"), this);
...
void BitcoinGUI::gotoSendBitCoinsPage(QString addr)
{
    if (walletFrame) walletFrame->gotoSendBitCoinsPage();
}
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::SFR, nFeeRequired));
