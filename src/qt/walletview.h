...
public:
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a saffroncoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public slots:
    ...
    /** Switch to send coins page */
    void gotoSendBitCoinsPage(QString addr = "");
