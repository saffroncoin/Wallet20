...
class CInv;
class CNode;
class CSFRAnonymizePool;
class CSFRAnonymizeSigner;
class CMasterNode;
...
extern CSFRAnonymizePool sfrAnonymizePool;
extern CSFRAnonymizeSigner sfrAnonymizeSigner;
extern std::vector<CMasterNode> sfrAnonymizeMasterNodes;
extern std::vector<CMasterNodeVote> sfrAnonymizeMasterNodeVotes;
...
/** Used to keep track of current status of SFRAnonymize pool
 */
class CSFRAnonymizePool
{
public:
    ...
    CSFRAnonymizePool()
    {
        ...
        if(!fTestNet) {
            strAddress = "SZkzBZ1Sf319kJwn89Te4Vit7AvUv1iky5";
        } else {
            strAddress = "SZkzBZ1Sf319kJwn89Te4Vit7AvUv1iky5";
        }
